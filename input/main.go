...
func getInput(year int, day int, cookie string) {
...
func parseFlags() (year int, day int, cookie string) {
	today := time.Now()
	...
	flag.IntVar(&year, "year", defaultYear, "year number to fetch, e.g. 2023")
...
func main() {
	year, day, cookie := parseFlags()
	getInput(year, day, cookie)
}
